...
from umi_collapser import sctools_imports
...
def umi_collapse_sorted_file(input_bam_filename: str,
    ...
    with tempfile.TemporaryDirectory() as temp_directory_name:
        ...
        with pysam.AlignmentFile(input_bam_filename, "rb", require_index=False) as input_bam:
...
def do_umi_collapse(input_file: str,
                 output_file: str,
                 verbose: bool = False,
